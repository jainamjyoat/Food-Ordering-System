...
// ... (keep your existing `initialFoodItems`, `CATEGORIES`, `DIETARY_OPTIONS` constants here) ...
...
export default function FoodMenu() {
  const { cart, addToCart, updateQuantity } = useCart(); // Use Cart Hooks
  
  // ... (keep your existing state: searchQuery, selectedCategories, etc.) ...
  ...
  // ... (keep your existing handlers: handleCategoryChange, etc.) ...
                    ...
                    <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-100 dark:border-[#452026]">
                      ...
                      {qty > 0 ? (
                        ...
                        <button 
                          ...
                          className="bg-primary hover:bg-red-600 text-white text-sm font-bold px-4 py-2 rounded-lg transition-colors flex items-center gap-2 cursor-pointer shadow-lg shadow-primary/20"
                        >
