    ...
    <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 flex gap-8 font-sans">
        ...
        <aside className="w-64 shrink-0 hidden lg:block sticky top-24 h-[calc(100vh-8rem)] overflow-y-auto pr-2 pb-10 hide-scrollbar">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-xs font-bold text-primary hover:text-red-600 transition-colors cursor-pointer">Reset All</button>
          </div>
            ...
            <div className="space-y-2">
              {[
                ...
                <label key={idx} className="flex items-center gap-3 cursor-pointer group">
                  <input defaultChecked={cat.checked} className="form-checkbox size-4 rounded text-primary border-gray-300 focus:ring-primary/50 dark:bg-white/5 dark:border-[#452026]" type="checkbox"/>
                  <span className="text-sm text-gray-600 dark:text-gray-300 group-hover:text-primary transition-colors font-medium">{cat.label}</span>
                  <span className="ml-auto text-xs text-gray-400 bg-gray-100 dark:bg-[#33181c] px-2 py-0.5 rounded-full">{cat.count}</span>
                </label>
              ))}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between text-sm text-[#181112] dark:text-white font-bold mb-2">
              <span>$0</span>
              <span className="text-primary">$250</span>
            </div>
            <input className="w-full h-1 bg-gray-200 dark:bg-[#33181c] rounded-lg appearance-none cursor-pointer" max="250" min="0" type="range" defaultValue="80"/>
            <div className="flex gap-2 mt-4">
              <div className="bg-white dark:bg-[#33181c] border border-gray-200 dark:border-[#452026] rounded px-3 py-1.5 text-sm text-center flex-1 dark:text-white font-medium">$10</div>
              <span className="text-gray-400 flex items-center">-</span>
              <div className="bg-white dark:bg-[#33181c] border border-gray-200 dark:border-[#452026] rounded px-3 py-1.5 text-sm text-center flex-1 dark:text-white font-medium">$80</div>
            </div>
          </div>
          <div className="h-px bg-gray-200 dark:bg-[#3a1d21] mb-6"></div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {["Vegan", "Gluten Free", "Halal"].map((diet, idx) => (
                <label key={idx} className="flex items-center gap-3 cursor-pointer group">
                  <input className="form-checkbox size-4 rounded text-primary border-gray-300 focus:ring-primary/50 dark:bg-white/5 dark:border-[#452026]" type="checkbox"/>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {[4, 3].map((stars, idx) => (
                <label key={idx} className="flex items-center gap-3 cursor-pointer group">
                  <input defaultChecked={idx === 0} className="form-radio size-4 text-primary border-gray-300 focus:ring-primary/50 dark:bg-white/5 dark:border-[#452026]" name="rating" type="radio"/>
        ...
        <section className="flex-1 min-w-0">
          ...
          <div className="mb-8 flex flex-col md:flex-row gap-4">
            <div className="relative flex-1 group">
              ...
              <input className="block w-full pl-12 pr-4 py-3.5 bg-white dark:bg-[#33181c] border border-gray-100 dark:border-[#452026] rounded-xl text-[#181112] dark:text-white placeholder-gray-400 shadow-sm focus:ring-2 focus:ring-primary/20 transition-all outline-none font-medium" placeholder="Search for burgers, pizza, or drinks..." type="text"/>
            </div>
            <div className="relative w-full md:w-56">
              <select className="block w-full pl-4 pr-10 py-3.5 bg-white dark:bg-[#33181c] border border-gray-100 dark:border-[#452026] rounded-xl text-[#181112] dark:text-white shadow-sm focus:ring-2 focus:ring-primary/20 cursor-pointer appearance-none font-medium">
          ...
          <div className="mb-8 flex gap-3 overflow-x-auto pb-2 hide-scrollbar lg:hidden">
            <button className="flex-shrink-0 px-4 py-2 bg-primary text-white rounded-full text-sm font-bold shadow-sm">All</button>
            {["Burgers", "Pizza", "Vegan"].map((cat) => (
              <button key={cat} className="flex-shrink-0 px-4 py-2 bg-white dark:bg-[#33181c] border border-gray-200 dark:border-[#452026] text-[#181112] dark:text-white rounded-full text-sm font-bold hover:border-primary hover:text-primary transition-all cursor-pointer">{cat}</button>
            ))}
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Showing 42 results</span>
          </div>
