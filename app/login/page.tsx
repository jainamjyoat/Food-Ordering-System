          ...
          */}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="relative w-full flex justify-center">
              {/* Styled Google button UI (visual only) */}
              <a
                className="w-full inline-flex justify-center items-center gap-2 py-3 px-4 bg-white dark:bg-surface-dark border border-neutral-light dark:border-neutral-dark rounded-xl hover:bg-gray-50 dark:hover:bg-neutral-dark transition-colors cursor-pointer text-sm font-semibold text-gray-700 dark:text-gray-200"
                href="#"
              ...
              >
                <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"></path>                </svg>
                Google
              </a>
              {/* Invisible overlay with actual Google Login to preserve functionality */}
